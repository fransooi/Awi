...
class BubbleAwiChat extends awibubbles.Bubble
{
	...
	async play( line, parameters, control )
	{
		...
		this.parameters.push( { name: 'userInput', value: parameters.userInput } );
		...
		var memories = this.awi.prompt.recallLastBubbles( 2 );
...
module.exports.Bubble = BubbleAwiChat;
